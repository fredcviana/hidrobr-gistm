...
import {
  ...
  GraduationCap, Building2, Bell, LogOut, Shield, Settings
} from 'lucide-react'
          ...
          <div className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-white/6 cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[10px] text-white/35 truncate">
                {profile?.role === 'hidrobr_admin' ? 'Admin HIDROBR' :
                 profile?.role === 'hidrobr_consultant' ? 'Consultor HIDROBR' :
                 profile?.role === 'client_admin' ? 'Admin Cliente' :
